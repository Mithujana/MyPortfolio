...
const defaultColors = ['#ffffff', '#dbeafe', '#cbd5e1'];
...
const fragment = /* glsl */ `
  ...
  void main() {
    ...
    if (uAlphaParticles < 0.5) {
      ...
      gl_FragColor = vec4(vColor + 0.18 * sin(uv.yxx + uTime + vRandom.y * 6.28), 1.0);
    } else {
      float circle = smoothstep(0.5, 0.4, d) * 0.8;
      gl_FragColor = vec4(vColor + 0.18 * sin(uv.yxx + uTime + vRandom.y * 6.28), circle);
    }
  }
`;
