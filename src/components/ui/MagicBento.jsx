      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              ...(card.color && card.color !== 'var(--background-dark)' ? { backgroundColor: card.color } : {}),
              ...
              >
                <div className="magic-bento-card__header">
                  <div className="magic-bento-card__label">
                    {card.icon && <span className="mr-2 text-primary">{card.icon}</span>}
                    {card.label}
                  </div>
                </div>
                <div className="magic-bento-card__content">
                  <h2 className="magic-bento-card__title" style={{color: card.titleColor}}>{card.title}</h2>
