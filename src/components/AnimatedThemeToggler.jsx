...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      if (document.documentElement.classList.contains("dark") !== newTheme) {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors flex items-center justify-center text-slate-800 dark:text-slate-200",
        className
      )}
      {...props}
    >
